...
import { userTasksColumns } from '@/features/tasks/configs/user-tasks-columns';
import {
...
export const UserTasksSection = () => {
	...
	const columns = useMemo(() => userTasksColumns(t, locale), [t, locale]);
...
export const UserTasksSectionSkeleton = () => {
	return (
		<div className="flex flex-1 flex-col gap-4 lg:gap-8">
			...
			<div className="hidden lg:block">
				<TasksFilterSkeleton showProjects showOrgs />
			</div>
